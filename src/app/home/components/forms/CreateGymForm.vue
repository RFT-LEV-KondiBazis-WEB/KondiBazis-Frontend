  ...
  <div class="px-8 py-6">
    ...
    <form @submit.prevent="send()">
      ...
      <div class="form-group mb-4" v-bind:class="{ 'has-error': errors.has('description') }">
        ...
        <textarea id="description" class="form-control" name="description" placeholder="Description" rows="3" v-model="description"></textarea>
      ...
      <div class="form-group mb-4" v-bind:class="{ 'has-error': errors.has('openingHours') }">
        ...
        <textarea id="openingHours" class="form-control" name="openingHours" placeholder="Opening hours" rows="3" v-model="openingHours"></textarea>
