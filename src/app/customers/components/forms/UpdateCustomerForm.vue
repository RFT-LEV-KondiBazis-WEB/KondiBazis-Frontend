    ...
    <form @submit.prevent="send()">
      <div class="flex row md:mb-0">
        <div class="form-group md:col-6 sm:col-12 sm:mb-4" v-bind:class="{ 'has-error': errors.first_name }">
          ...
          <input type="text" id="first_name" class="form-control" name="first_name" placeholder="First name" autofocus v-model="customer.first_name">
        ...
        <div class="form-group md:col-6 sm:col-12 sm:mb-4" v-bind:class="{ 'has-error': errors.last_name }">
          ...
          <input type="text" id="last_name" class="form-control" name="last_name" placeholder="Last name" v-model="customer.last_name">
      ...
      <div class="flex row md:mb-0">
        ...
        <div class="form-group md:col-6 sm:col-12 sm:mb-4" v-bind:class="{ 'has-error': errors.birth_date }">
          ...
          <input type="text" id="birth_date" class="form-control" name="birth_date" placeholder="Birth date" autofocus v-model="customer.birth_date">
